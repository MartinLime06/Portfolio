...
function Navbar() {
    return (
        <div className="flex justify-center items-center scroll-smooth animate-ease-out lg:p-10 p-5 text-xs lg:text-sm">
          <div className='fixed top-5 bg-black items-center px-10 py-5 rounded-full border-1 border-gray-500/10 shadow-sm shadow-neutral-500 z-100 gap-5'>

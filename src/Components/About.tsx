function About() {
    return(
        <div id="about" className="flex justify-center items-center flex-col">
            ...
            <div className='flex lg:mb-40 w-300 overflow-hidden border-1 border-gray-900/50 rounded-2xl inset-shadow-xs'>

                <div className='flex gap-5 mb-10 mt-10 ml-5 animate-infinite-scroll'>

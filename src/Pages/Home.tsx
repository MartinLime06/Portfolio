    ...
    return (
        <div>
            ...
            <div className='flex flex-col justify-center items-center h-screen' id='header'>
                ...
                <div className='m-5'>
                    <Link to='work'><button className='bg-zinc-900 px-10 py-4 rounded-lg border-1 border-gray-500 cursor-pointer hover:bg-zinc-800 animate-pulse'>Mitt Arbeid  <FontAwesomeIcon icon={faChevronRight} /></button></Link>
